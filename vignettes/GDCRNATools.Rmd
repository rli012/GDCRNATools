...
```{r parse meta2, message=FALSE, warning=FALSE, eval=FALSE}
####### Parse RNAseq metadata #######
...
```{r filter meta, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r filter meta2, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r extract, message=FALSE, warning=FALSE, eval=FALSE}
### All DEGs
...
### Volcano plot
```{r volcano, fig.align='center', fig.width=5, message=FALSE, warning=FALSE, eval=FALSE}
gdcVolcanoPlot(DEGAll)
```

![](figures/gdcVolcanoPlot.png)

### Barplot
```{r barplot, fig.align='center', fig.height=6, message=FALSE, warning=FALSE, eval=FALSE}
gdcBarPlot(deg = deALL, angle = 45, data.type = 'RNAseq')
```

![](figures/gdcBarPlot.png)
