---
title: 'GDCRNATools: integrative analysis of protein coding genes, 
long non-coding genes, and microRNAs in GDC'
author: 'Ruidong Li and Han Qu'
date: "Last update: `r format(Sys.time(), '%d %B, %Y')`" 
vignette: >
    %\VignetteIndexEntry{'GDCRNATools: integrative analysis of 
    protein coding genes, long non-coding genes, and microRNAs in GDC'}
...
Here we use a small dataset to show the most basic steps for ceRNA network analysis. More detailed instruction of each step is in the [Case Study](#case) section.
...
testdir <- tempdir()
rnadir <- paste(testdir, 'RNAseq', sep='/')
mirdir <- paste(testdir, 'miRNAs', sep='/')
...
Users can use the internally incoporated databases of miRNA-mRNA (starBase v2.0, miRcode, and mirTarBase v7.0) and miRNA-lncRNA (starBase v2.0, miRcode, spongeScan) interactions to perform the ceRNA network analysis.
...
```{r shiny pathview, message=FALSE, warning=FALSE, include=FALSE, eval=TRUE}
library(pathview)
deg <- deALL$logFC
